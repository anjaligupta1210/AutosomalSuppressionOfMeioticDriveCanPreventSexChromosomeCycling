#Simulation: Test invasion of Y-linked suppressor where the initial population is at equilibrium for X-linked driver and does not contain an autosomal suppressor
#Code: Anjali Gupta
...
#This nested "for loop" loops over a range of possible parameters and tests for the invasion of Y-linked suppressors in a population that is at equilibrium for X-linked drivers and autosomal suppressors are absent in initial population
...
write.csv(result_all,"YsupInvasion_AsupAbsentInInitialPop_Fig1-2_S1-5.csv",row.names=FALSE)
